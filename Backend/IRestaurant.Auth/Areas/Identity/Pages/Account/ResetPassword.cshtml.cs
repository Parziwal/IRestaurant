...
namespace IRestaurant.Auth.Areas.Identity.Pages.Account
{
    ...
    public class ResetPasswordModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Display(Name = "Jelszó")]
            [StringLength(100, ErrorMessage = "A jelszó legalább {2} és legfeljebb {1} karakteres lehet.", MinimumLength = 6)]
        ...
        public IActionResult OnGet(string code = null)
        {
            if (code == null)
            {
                return BadRequest("A jelszó visszaállítás nem lehetséges.");
            }
            else
            {
