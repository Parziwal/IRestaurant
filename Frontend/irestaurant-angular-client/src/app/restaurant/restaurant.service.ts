...
export class RestaurantService {
  ...
  private restaurantAPIURL = environment.webAPIURL + "/restaurant";
  ...
  getRestaurantList(options?: {searchTerm?: string}) {
    ...
    return this.http.get<RestaurantOverview[]>(this.restaurantAPIURL, {
      params: params
    });
  }
  ...
  getRestaurantDetails(restaurantId: number) {
    return this.http.get<RestaurantDetails>(`${this.restaurantAPIURL}/${restaurantId}`);
  }
  ...
  getMyRestaurantDetails() {
    return this.http.get<RestaurantDetails>(`${this.restaurantAPIURL}/myrestaurant`);
  }
  ...
  editMyRestaurant(editedRestaurant: EditRestaurant) {
    return this.http.put<RestaurantDetails>(`${this.restaurantAPIURL}/myrestaurant`, editedRestaurant);
  }
  ...
  uploadImageMyRestaurant(image: File) {
    ...
    return this.http.post<{relativeImagePath: string}>(`${this.restaurantAPIURL}/myrestaurant/image`, imageFormData);
  }
  ...
  getMyRestaurantSettings() {
    return this.http.get<RestaurantSettings>(`${this.restaurantAPIURL}/myrestaurant/settings`);
  }
   ...
   */
  turnOnOrderOption() {
    return this.http.patch(`${this.restaurantAPIURL}/myrestaurant/order/turnon`, null);
  }
   ...
   */
  turnOffOrderOption() {
    return this.http.patch(`${this.restaurantAPIURL}/myrestaurant/order/turnoff`, null);
  }
  ...
  addRestaurantToFavourite(restaurantId: number) {
    return this.http.post(`${this.restaurantAPIURL}/favourite/add/${restaurantId}`, null);
  }
  ...
  removeRestaurantFromFavourite(restaurantId: number) {
    return this.http.delete(`${this.restaurantAPIURL}/favourite/remove/${restaurantId}`);
  }
  ...
  getGuestFavouriteRestaurantList(options?: {searchTerm?: string}) {
    ...
    let params = new HttpParams();
    params = params.append("restaurantName", searchTerm);
    return this.http.get<RestaurantOverview[]>(`${this.restaurantAPIURL}/favourite`, {
      params: params
    });
  }
}
